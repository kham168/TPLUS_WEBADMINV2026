    ...
    <section class="banner-section">
      ...
      <div class="header banner-header" v-show="!firstLoad">
        <v-row>
          ...
          <v-btn
            @click="saveChangeOrderBanner"
            class="btn btn-create ml-5"
            v-show="checkbox"
          >
        ...
        >
          ...
          <template v-slot:body="props">
            ...
            >
              ...
              >
                <td>
                  <v-icon small class="grab-icon"> mdi-arrow-all </v-icon>
                  <span>&nbsp</span> {{ index + 1 }}
                </td>
                <td>
                  <v-img
                    :src="item.image"
                  ...
                  <v-menu offset-y>
                    ...
                    <v-list>
                      ...
                      >
                        <v-list-item-icon>
                          <v-icon class="mr-3" small>{{
                            $t("Banner.table.options.iconEdit")
                          }}</v-icon>
                          <v-list-item-title>
                      ...
                      <v-list-item link @click="onDelete(item.id)">
                        <v-list-item-icon>
                          <v-icon class="mr-3" small>{{
                            $t("Banner.table.options.delicon")
                          }}</v-icon>
                          <v-list-item-title>
            ...
            >
              ...
              >
                ...
                <td class="text-limit">
                  {{ item.BannerTrans[0].description }}
                </td>
