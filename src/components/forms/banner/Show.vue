        ...
        >
          <v-row class="body-1 pt-5">
            <v-col align="left" cols="12">
              ...
              <h2> {{ $t('Banner.Create.form.banner_name') }}</h2>
              <p v-if="tab===0"> {{ bannerName }}</p>
              <p v-else> {{ bannerNameEng }}</p>
            </v-col>
          ...
          <v-row class="body-2">
            <v-col align="left" cols="12">
              ...
              <h2>{{ $t('Banner.Create.form.link') }}</h2>
              <p v-if="tab===0"> {{ link }}</p>
              <p v-else> {{ linkEng }}</p>
            </v-col>
          ...
          <v-row class="body-3">
            <v-col align="left" cols="12">
              ...
              <h2>{{ $t('Banner.Create.form.description') }}</h2>
